...
alt_qwer = dop_alt(qwertsetalt, score_symb)
alt_ant = dop_alt(antsetalt, score_symb)
...
key_stress_qwer = (key_stress_counter(key_stress_qwer, score_symb, qwerty, shift_qwer,alt_qwer))
key_stress_ant = (key_stress_counter(key_stress_ant, score_symb, ant, shift_ant,alt_ant))
...
grams_friq_ant = gram_hendler(gramlist,dicktor,2)
#print(grams_friq)
# Вывод графики
